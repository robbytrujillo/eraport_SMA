...
class NilaiBulanSts extends CI_Controller {
    ...
    public function input_bulansts($kelas_kd,$mapel_kd)
    {
        // var_dump($kelas_kd);
        // var_dump($mapel_kd);die;
        $data['nilaiBulanSts'] = true;
        $data['rowI'] = $this->mengajar_m->getDataByMapel(_active_years()->idtahun_akademik,_active_years()->semester,$kelas_kd,$mapel_kd);
        $data['content'] = 'nilaiBulananSts/input_bulan_sts';
        $this->load->view('index',$data);
    }
    
    public function input_bulanan_sts($kelas_kd,$mapel_kd)
    {
        // var_dump($kelas_kd);
        // var_dump($mapel_kd);die;
        $data['nilaiBulanan'] = true;
        $data['rowI'] = $this->mengajar_m->getDataByMapel(_active_years()->idtahun_akademik,_active_years()->semester,$kelas_kd,$mapel_kd);
        $data['content'] = 'nilaiBulananSts/input_bulanan_sts';
        $this->load->view('index',$data);
    }
